  ...
  try {
    ...
    try {
      ...
      const agentAlertResult = await sendEmail({
        to: agentEmail,
        subject: `✅ NEW CONFIRMED VISIT: ${visit.client_name} → ${visit.property_name}`,
